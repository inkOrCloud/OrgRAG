...
def create_app(args):
    ...
    # Custom StaticFiles class for smart caching and SPA fallback
    class SmartStaticFiles(StaticFiles):
        async def get_response(self, path: str, scope):
            ...
            if is_html:
                ...
                # JS/CSS/image assets built by Vite carry a content hash in
                # their filename, so they are safe to cache for a long time.
                response.headers["Cache-Control"] = (
